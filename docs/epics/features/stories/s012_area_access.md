...
**Acceptance Criteria:**
*   [ ] A barrier object is added to the scene, initially blocking a path
*   [ ] When the clue reaction is triggered, the barrier object becomes non-blocking
*   [ ] The player can then walk through the area previously blocked by the barrier
