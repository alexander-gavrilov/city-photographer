# Story: Interactive Clue Object

**Feature:** [Interactive Clue Setup](../f004_interactive_clue_setup.md)

**Description:** Create and place a 3D object in the scene that is visually distinct from the surrounding environment to serve as the first interactive 'clue'.

**Requirements:** Must be a Three.js Mesh. Must have a material that makes it easily identifiable.
...
- [Position Clue Object](tasks/e001f004s009t032_position_clue_object.md)
